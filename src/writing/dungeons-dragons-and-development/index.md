...
<div style="background-color: var(--blockquote-bg); border-left: 4px solid #007bff; padding: 15px; margin: 15px 0; transition: background-color var(--transition-speed);">
...
<div style="background-color: var(--blockquote-bg); border-left: 4px solid #6f42c1; padding: 15px; margin: 15px 0; transition: background-color var(--transition-speed);">
...
<div style="background-color: var(--blockquote-bg); border-left: 4px solid #fd7e14; padding: 15px; margin: 15px 0; transition: background-color var(--transition-speed);">
