...
When someone suggests a rewrite, they're often trying to solve the <i>wrong</i> problem. Zoom out, define the problem you are trying to solve, and define a clear and efficient architecture:
